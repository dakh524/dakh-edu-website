export default function handler(req, res) {
  ...
  // Hardcoded Supabase URL so the API can construct the image link
  // We use the known supabase URL from your project
  ...
  const html = `
    ...
    <head>
        ...
        <title>Internship Completed - ${domain}</title>
        
        <!-- Open Graph / LinkedIn / Facebook Meta Tags -->
        <meta property="og:title" content="Internship Completed at DAKH Edu Solutions">
        <meta property="og:description" content="I successfully completed an internship in ${domain}!">
        ...
        <meta name="twitter:description" content="I successfully completed an internship in ${domain}!">
